...
| C-bond | Interaction of $C^{sp3}$ (donnor) with carbonyl O (acceptor) through $n \rightarrow \sigma^*$ electron delocalization: $Z-C^{sp3} \cdots O=C$. Where *Z* is N, C or O. | Can be up to -4 | $2.5 \leq d_{C \cdots O} \leq 3.6$ | $160 \leq \widehat{Z-C\cdots O}\leq 180$ <br/> $160 \leq \widehat{C\cdots O=C}\leq 180$ |
