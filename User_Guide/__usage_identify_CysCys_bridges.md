...
**cys_bridges_inPDB**(pdb_file, *outfile=True, logfile=True*, use_tqdm=False)
...
| use_tqdm | boolean | Use tqdm to display the progress bar. <br/> Default value: False | optional |
